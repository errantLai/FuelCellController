...
// Other
#define ARRAY_SIZE 200 // will need to be reduced for testing on an uno
...
void System() {
  ...
  if (digitalRead(SYSTEM_ON_PIN) == HIGH) { //logic
    fc_on = true;
  }
